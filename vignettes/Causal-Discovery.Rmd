...
For all levels of alpha we got 12 edges with the PC-algorithm:
...
When running the PC-algorithm with kernel independence test, we get 12 edges if we set alpha = 0.16:
...
When running the PC-algorithm with the generalised covariance measure as our choice of independence test, we get 12 edges for both levels of alpha:
